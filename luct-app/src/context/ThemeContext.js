...
export const darkTheme = {
  primary: PALETTE.primary,
  secondary: PALETTE.secondary,
  // Dark mode keeps the page dark while preserving strong contrast in cards and forms.
  bg: PALETTE.dark,
  bgSecondary: '#181C22',
  bgCard: '#20252D',
  bgCardAlt: '#292F38',
